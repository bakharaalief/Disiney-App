  ...
  void bookmark() async {
    ...
    if (user != null) {
      ...
      if (_bookmarkColor == Colors.white) {
        ...
        Toast.show("Add to Bookmark", context,
      ...
      //remove bookmark
        ...
        Toast.show("remove from Bookmark", context,
            duration: Toast.LENGTH_SHORT,
            gravity: Toast.BOTTOM,
            backgroundColor: ColorData().blue,
            textColor: Colors.white);
                      ...
                      background: Container(
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(
                                    "https://image.tmdb.org/t/p/original/${_movieDetail.posterPath}"))),
                        child: Container(
                          decoration: BoxDecoration(
                        ...
                        Container(
                          ...
                          child: Center(
                            child: ListView.builder(
                                itemCount: _movieDetail.genres.length > 3
                                    ? 3
                                    : _movieDetail.genres.length,
                                shrinkWrap: true,
